...
export VCPKG_NUGET_REPOSITORY=https://github.com/krauthaufen/ProjSharp
./.vcpkg/vcpkg/vcpkg install proj --triplet $VCPKG_TRIPLET --binarysource='clear;nuget,GitHub,readwrite;nugettimeout,1000'
